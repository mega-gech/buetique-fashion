              ...
              <div className="relative aspect-[3/4] overflow-hidden bg-gray-100">
                ...
                >
                  ...
                  <button 
                    ...
                    className={`absolute top-4 right-4 transition-colors duration-300 ${likedItems[product.id] ? 'text-red-500' : 'text-white hover:text-red-500'}`}
                    title="Add to Wishlist"
                  >
                    <Heart size={24} className={likedItems[product.id] ? 'fill-current' : ''} />
                  </button>
                </div>
              </div>
